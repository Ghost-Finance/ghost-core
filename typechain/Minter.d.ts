...
interface MinterInterface extends ethers.utils.Interface {
  functions: {
    ...
    "addDebtPool(address)": FunctionFragment;
    ...
    "debtPoolBurn(address,uint256)": FunctionFragment;
    "debtPoolMint(address,uint256)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "addDebtPool", values: [string]): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "debtPoolBurn",
    values: [string, BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "debtPoolMint",
    values: [string, BigNumberish]
  ): string;
...
export class Minter extends Contract {
  ...
  callStatic: {
    ...
    addDebtPool(debtPool_: string, overrides?: CallOverrides): Promise<void>;
  ...
  estimateGas: {
    ...
    addDebtPool(debtPool_: string, overrides?: Overrides): Promise<BigNumber>;
