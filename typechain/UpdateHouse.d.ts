...
interface UpdateHouseInterface extends ethers.utils.Interface {
  functions: {
    ...
    "getPositionFix(uint8,uint256,uint256,uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "getPositionFix",
  ...
  events: {
    ...
    "Decrease(address,tuple)": EventFragment;
    "Finish(address,uint8,uint8)": EventFragment;
    "Increase(address,tuple)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "Decrease"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Finish"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Increase"): EventFragment;
...
export class UpdateHouse extends Contract {
  ...
  functions: {
    ...
    getPositionFix(
      ...
      synthTokenAmount: BigNumberish,
      currentTokenSynthAmount: BigNumberish,
      lastTokenSynthAmount: BigNumberish,
      overrides?: Overrides
    ): Promise<ContractTransaction>;

    "getPositionFix(uint8,uint256,uint256,uint256)"(
      direction: BigNumberish,
      synthTokenAmount: BigNumberish,
      currentTokenSynthAmount: BigNumberish,
      lastTokenSynthAmount: BigNumberish,
  ...
  filters: {
    ...
    Decrease(account: null, data: null): EventFilter;

    Finish(account: null, direction: null, status: null): EventFilter;

    Increase(account: null, data: null): EventFilter;
